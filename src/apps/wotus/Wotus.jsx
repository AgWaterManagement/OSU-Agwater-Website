    ...
    return (
        <>
            <div style={{ padding: '10px' }}>
                ...
                <Paragraph>This application explores protection levels provided to streams and wetlands associated with Waters of the United States (WOTUS).
                ...
                {showIntro ? (<>
                    ...
                    <Paragraph>
                        ...
                        State-level programs may also contribute to the protection of these water bodies through additional regulations, conservation easements, and habitat restoration initiatives.</Paragraph>
                    <Paragraph>
                        ...
                        Higher-order streams (e.g., Order 4 and above) typically represent larger stream reaches with greater flow volumes. </Paragraph>
                    <Paragraph>
                    ...
                    <Paragraph>A complete <a href='https://www.fws.gov/sites/default/files/documents/Classification-of-Wetlands-and-Deepwater-Habitats-of-the-United-States-2013.pdf'>
                        description of classification systems used to characterize wetlands</a> is available from the US Fish and Wildlife Service. A <a href='https://www.fws.gov/sites/default/files/documents/wetlands-and-deepwater-map-code-diagram.pdf'>Wetlands and Deepwater Habitats code diagram</a> is also available.</Paragraph>
                ...
                <Row gutter={16} style={{}}>
                    <Col xs={24} md={24}>
                        ...
                        <div style={{ marginBottom: '0.5em', paddingLeft: '0.5em' }}>
                            <Text style={{ fontWeight: 'bold', fontSize: '16px',}}>Select a State:</Text>&nbsp;&nbsp;
                            <Select
                ...
                <Tabs defaultActiveKey='streams' items={[
                    { key: 'streams', label: 'Streams', children: (<Text>Select desired levels of stream protection below; results will be updated to reflect selection(s)</Text>), },
                    { key: 'wetlands', label: 'Wetlands', children: (<Text>Select desired levels of wetland protection below; results will be updated to reflect selection(s)</Text>), }]}
                    ...
                    <Row gutter={16} style={{}}>
                        <Col xs={24} md={6} style={{ border: '1px solid #ccc', borderRadius: '4px', marginBottom: '10px' }}>
                            <div style={{ marginTop: '1.0em', marginBottom: '0.5em', paddingLeft: '0.5em' }}>
                                ...
                                <Text style={{ fontSize: 'medium', fontWeight: 500 }}>Include the following Stream Types: </Text>

                                <Popover open={wetlandTypePopoverVisible} onOpenChange={setWetlandTypePopoverVisible} content={
                                    <>
                                        <Paragraph><b>Stream/River</b> are dominated by herbaceous plants such as grasses, sedges, cattails, and rushes that grow in shallow water or saturated soils. Water is present at or above the soil surface for at least part of the year, but trees and shrubs are sparse or absent. These wetlands include marshes and wet meadows and are important for flood storage, nutrient cycling, and wildlife habitat.</Paragraph>
                                        <Paragraph><b>Freshwater forested/shrub wetlands</b> are dominated by woody vegetation, including trees (forested) or shrubs (scrub-shrub). They occur on saturated or flooded soils and include swamps, bottomland hardwood forests, and shrub wetlands. These systems play a key role in flood attenuation, groundwater recharge, and providing complex habitat structure.</Paragraph>
                                        <Paragraph><b>Freshwater ponds</b> are small, shallow, non-tidal water bodies with standing water, often surrounded by emergent or aquatic vegetation. They are deeper than marshes but smaller than lakes and may be natural or man-made. Ponds provide aquatic habitat, sediment storage, and localized water retention.</Paragraph>
                                        ...
                                        <Paragraph><b>Riverine</b> systems consist of flowing freshwater channels such as rivers and streams, including their beds, banks, and associated in-channel wetlands. Water movement is primarily unidirectional, driven by watershed runoff. Riverine areas are shaped by current, erosion, and sediment transport and are critical for longitudinal connectivity.</Paragraph>
                                        <Paragraph><b>Estuarine and marine deepwater systems</b> are permanently flooded areas below the low-tide line in estuaries or the open ocean. They lack emergent vegetation and include subtidal channels, bays, and nearshore marine waters. These areas support fish, invertebrates, and submerged aquatic vegetation.</Paragraph>
                                        <Paragraph><b>Estuarine and marine wetlands</b> are tidal areas influenced by saline or brackish water where vegetation is present. They include salt marshes, tidal flats with vegetation, and mangrove forests. These wetlands buffer storm surge, improve water quality, and provide essential coastal habitat.</Paragraph>
                                        <Paragraph>The “<b>Other</b>” category includes water or wetland features that do not clearly fit into the standard classifications or represent highly altered systems. Examples may include wastewater treatment wetlands, drainage features, or mixed or transitional areas. This category is often used when classification uncertainty exists or when features serve specialized or artificial functions.</Paragraph>
                                        <br />
                                        <a onClick={() => setWetlandTypePopoverVisible(false)}>Close</a>
                                    </>} title="Wetland Class Definitions" trigger="click">
                                    <QuestionCircleTwoTone />
                                </Popover>
                                <Paragraph style={{ paddingLeft: '0px' }}>Only the stream types checked below will be included in this analysis.</Paragraph>
                                ...
                                <Paragraph style={{paddingLeft: '0px' }}>Below, specify the protection criteria you would like to apply to streams.
                                </Paragraph>
                                <Divider />


                                <Radio checked={useStreamOrder} onChange={(e) => { onChangeUseStreamOrder(e.target.checked); }}>
                                    <Text style={{ fontSize: 'medium', fontWeight: 500 }}>Stream Orders to Protect:</Text>
                                </Radio>
                                <Popover open={streamOrderPopoverVisible} onOpenChange={setStreamOrderPopoverVisible} content={(
                                    <>
                                        <div style={{ textAlign: 'center', width: '50%', float: 'right' }}>
                                            ...
                                            <br />
                                            <Text>By <a href="//commons.wikimedia.org/wiki/User:Kilom691" title="User:Kilom691">Kilom691</a>,
                                        ...
                                        <div>
                                            ...
                                            <Paragraph>Rivers of the first order are the outermost (headwater) tributaries.
                                            ...
                                            <Paragraph>For example, if two first-order streams merge, they form a second-order stream. If a first-order stream merges with a second-order stream,
                                ...
                                <div style={{ marginTop: '0.5em' }}>
                                    <Radio checked={useDrainageArea.current} onChange={() => onChangeUseStreamOrder(false)}>
                                        <Text style={{ fontSize: 'medium', fontWeight: 500 }}>Minimum Drainage Area to Protect:</Text>
                                    </Radio>

                                    <Popover open={drainageAreaPopoverVisible} onOpenChange={setDrainageAreaPopoverVisible} content={(
                                        <>
                                            <Paragraph>In stream protection, minimum drainage area refers to the smallest contributing watershed size required for a wetland
                                            ...
                                            <Paragraph>From a regulatory and planning perspective, minimum drainage area helps agencies distinguish between wetlands that function as part
                                    ...
                                    />&nbsp;<Text>acres</Text>
                                    <div><Text>(smaller numbers result in more protection)</Text></div>
                                </div>
                            </div>
                        </Col>
                    ...
                    <Row gutter={16} style={{}}>
                        <Col xs={24} md={6} style={{ border: '1px solid #ccc', borderRadius: '4px', marginBottom: '10px' }}>
                            <div style={{ marginBottom: '0.5em', marginTop: '1.0em', paddingLeft: '0.5em' }}>
                                ...
                                <Text style={{fontSize: 'medium', fontWeight: 500 }}>Include the following Wetland Types: </Text>

                                <Popover open={wetlandTypePopoverVisible} onOpenChange={setWetlandTypePopoverVisible} content={
                                    <>
                                        <Paragraph><b>Freshwater emergent wetlands</b> are dominated by herbaceous plants such as grasses, sedges, cattails, and rushes that grow in shallow water or saturated soils. Water is present at or above the soil surface for at least part of the year, but trees and shrubs are sparse or absent. These wetlands include marshes and wet meadows and are important for flood storage, nutrient cycling, and wildlife habitat.</Paragraph>
                                        <Paragraph><b>Freshwater forested/shrub wetlands</b> are dominated by woody vegetation, including trees (forested) or shrubs (scrub-shrub). They occur on saturated or flooded soils and include swamps, bottomland hardwood forests, and shrub wetlands. These systems play a key role in flood attenuation, groundwater recharge, and providing complex habitat structure.</Paragraph>
                                        <Paragraph><b>Freshwater ponds</b> are small, shallow, non-tidal water bodies with standing water, often surrounded by emergent or aquatic vegetation. They are deeper than marshes but smaller than lakes and may be natural or man-made. Ponds provide aquatic habitat, sediment storage, and localized water retention.</Paragraph>
                                        <Paragraph><b>Lakes</b> are larger, deeper inland freshwater bodies with standing water and relatively stable water levels. They typically have open water zones that may support submerged or floating vegetation, with emergent wetlands along their margins. Lakes influence regional hydrology and support diverse aquatic ecosystems.</Paragraph>
                                        <Paragraph><b>Riverine</b> systems consist of flowing freshwater channels such as rivers and streams, including their beds, banks, and associated in-channel wetlands. Water movement is primarily unidirectional, driven by watershed runoff. Riverine areas are shaped by current, erosion, and sediment transport and are critical for longitudinal connectivity.</Paragraph>
                                ...
                                <Paragraph style={{ paddingLeft: '0px' }}>Only the wetland types checked below will be included in this analysis.</Paragraph>
                                <div style={{ marginTop: '1em', marginBottom: '10px' }}>
                                ...
                                <Divider />
                                <Paragraph style={{ paddingLeft: '0px' }}>Below, specify the protection criteria you would like to apply to wetlands.
                                ...
                                <br />
                                <div style={{ marginTop: '0.5em' }}>
                                    <Text>Minimum distance to stream:&nbsp;</Text>
                                    <InputNumber
                                ...
                                <Popover open={hydroRegimePopoverVisible} onOpenChange={setHydroRegimePopoverVisible} content={
                                    <>
                                        ...
                                        <Paragraph><b>Semipermanently Flooded (F, N, Q)</b>: Areas where surface water persists through most of the growing season in most years, with only brief or infrequent periods of exposure. Water depths may fluctuate but rarely drop below the soil surface. These wetlands often support emergent, floating, or submerged aquatic vegetation.</Paragraph>
                                        <Paragraph><b>Intermittently Exposed (G, M, T)</b>: Areas that are usually covered by shallow surface water but periodically exposed due to seasonal drawdown, drought, or tidal cycles. Exposure is irregular or short-lived relative to flooding duration. Vegetation and substrate are adapted to alternating wet and exposed conditions.</Paragraph>
                                        <Paragraph><b>Permanently Flooded (H, L, V)</b>: Areas where surface water is present year-round in all years, except during extreme drought. Water depths are generally stable and consistently above the soil surface. These systems support submerged or floating aquatic vegetation or may be unvegetated open water.</Paragraph>
                                        <br />
                                ...
                                <br />
                                <Paragraph style={{ paddingLeft: '0px' }}>Specify the hydrologic regimes to protect below</Paragraph>
                                <Paragraph>Drier</Paragraph>
